...
namespace PixelCrushers.DialogueSystem
{
    ...
    public class UnityUIQuestLogWindow : QuestLogWindow
    {
        ...
        private List<UnityUIQuestGroupTemplate> groupTemplateInstances = new List<UnityUIQuestGroupTemplate>();

        private List<UnityUIQuestTemplate> questTemplateInstances = new List<UnityUIQuestTemplate>();

        private List<UnityUIQuestGroupTemplate> unusedGroupTemplateInstances = new List<UnityUIQuestGroupTemplate>();

        private List<UnityUIQuestTemplate> unusedQuestTemplateInstances = new List<UnityUIQuestTemplate>();
        ...
        protected void SetQuestDetails(UnityUIQuestTemplate questControl, QuestInfo questInfo)
        { 
